...
interface TimePickerThemeInput {
  color: string;
  errorColor: string;
  fontWeight: string;
  fontSize: string;
...
interface TimePickerThemeIcon {
  color: string;
}

interface TimePickerThemePopup {
  zIndex: string;
  boxShadow: string;
  background: string;
  fontSize: string;
...
export interface TimePickerTheme {
  base: TimePickerThemeBase;
  input: TimePickerThemeInput;
  icon: TimePickerThemeIcon;
  popup: TimePickerThemePopup;
}

export const timePickerTheme: TimePickerTheme = {
  base: {
